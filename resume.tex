...
\resumeItem{Flink}
{
  ...
  \begin{itemize}[label=\textbf{--}]
    ...
    \item Created a \href{https://www.youtube.com/watch?v=tB4rx_W9Xqw}{system} enabling users to backfill Flink pipelines using Apache Iceberg without code changes, eliminating the need to maintain separate batch jobs during outages.
