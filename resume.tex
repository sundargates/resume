...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  ...
  \textit{\small{Detailed Resume}} \href{https://sundaram.io/about-me}{https://sundaram.io/about-me} & +1(650)-666-9264 \\
\end{tabular*}
...
% say that I am one of the leads on the data platform team spearheading projects that are both deep and wide in scope.

\role{I am one of the leads on the data platform team at Netflix, spearheading projects in the data processing space that are both deep and wide in scope.}
\resumeItemListStart
\resumeItem{Mantis}
{
  \href{https://netflix.github.io/mantis/}{Mantis} is a stream processing engine developed at Netflix, designed to address the unique challenges posed by operational data.
  Mantis handles 50k+ jobs/day, processing 100 PBs of data on 30k+ containers.
  ...
  \begin{itemize}[label=\textbf{--}]
    \item
          ...
          Guided a team of senior engineers from prototype to production, year-long migration and open-sourcing.
    \item
...
\resumeItem{Flink}
{
  ...
  \begin{itemize}[label=\textbf{--}]
    ...
    \item Created a \href{https://sundaram.io/slides/dais22.pdf}{system} enabling users to backfill Flink pipelines using Apache Iceberg without code changes, eliminating the need to maintain separate batch jobs during outages.
...
\vspace{3pt}
\small{\textit{\href{https://www.mitacs.ca/our-innovation-insights/outstanding-young-researchers-honoured-at-mitacs-inaugural-awards-ceremony/}{Mitacs Outstanding Undergraduate Research Award}}}
\resumeSubHeadingListEnd
